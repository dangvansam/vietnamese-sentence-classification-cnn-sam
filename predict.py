...
def predict_unseen_data():
	...
	test_examples = json.loads(open(test_file,encoding='utf-8').read())
	...
	y_test = None
	if 'lable' in test_examples[0]:
		y_raw = [example['lable'] for example in test_examples]
	...
	if y_test is not None:
		...
		with open('./data/small_samples_prediction.json', 'w',encoding='utf-8') as outfile:
